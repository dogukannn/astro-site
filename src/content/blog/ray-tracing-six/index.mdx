...
description: 'Here we will implement monte carlo path tracing with BRDFs, and optimize it with Importance Sampling, Next Event Estimation and Russian Roulette.'
date: 2025-01-11
...
<Figure caption="Rendering equation with BRDF part hightlighted">
  ![Rendering equation with BRDF part hightlighted](./assets/rendering_eq.png)
</Figure>



<Figure caption="BRDF hemisphere representation, each different BRDF introduces different distribution on the surface">
  ![BRDF hemisphere representation, each different BRDF introduces different distribution on the surface](./assets/brdf_hemisphere.png)
</Figure>
...
<Figure caption="Bling Phong BRDF equation">
  ![Bling Phong BRDF equation](./assets/blinn_phong_brdf_eq.png)
</Figure>



<Figure caption="Bling Phong BRDF sphere">
  ![Bling Phong BRDF sphere](./assets/brdf_blinnphong_original.png)
</Figure>



<Figure caption="Modified Bling Phong BRDF equation">
  ![Modified Bling Phong BRDF equation](./assets/modified_blinn_phong_brdf_eq.png)
</Figure>



<Figure caption="Modified Bling Phong BRDF sphere">
  ![Modified Bling Phong BRDF sphere](./assets/brdf_blinnphong_modified.png)
</Figure>



<Figure caption="Normalized Modified Bling Phong BRDF equation">
  ![Normalized Modified Bling Phong BRDF equation](./assets/normalized_modified_blinn_phong_brdf_eq.png)
</Figure>



<Figure caption="Normalized Modified Bling Phong BRDF sphere">
  ![Normalized Modified Bling Phong BRDF sphere](./assets/brdf_blinnphong_modified_normalized.png)
</Figure>



<Figure caption="Killeroo model with Bling Phong BRDF">
  ![Killeroo model with Bling Phong BRDF](./assets/killeroo_blinnphong.png)
</Figure>



<Figure caption="Phong BRDF equation">
  ![Phong BRDF equation](./assets/phong_brdf_eq.png)
</Figure>



<Figure caption="Phong BRDF sphere">
  ![Phong BRDF sphere](./assets/brdf_phong_original.png)
</Figure>



<Figure caption="Modified Phong BRDF equation">
  ![Modified Phong BRDF equation](./assets/modified_phong_brdf_eq.png)
</Figure>



<Figure caption="Modified Phong BRDF sphere">
  ![Modified Phong BRDF sphere](./assets/brdf_phong_modified.png)
</Figure>



<Figure caption="Normalized Modified Phong BRDF equation">
  ![Normalized Modified Phong BRDF equation](./assets/normalized_modified_phong_brdf_eq.png)
</Figure>



<Figure caption="Normalized Modified Phong BRDF sphere">
  ![Normalized Modified Phong BRDF sphere](./assets/brdf_phong_modified_normalized.png)
</Figure>




<Figure caption="Torrance-Sparrow BRDF equation, F term is the Fresnel reflection term, D term is the micro-facet distribution term, G term comes from the shadowing and masking from the micro-facets">
  ![Torrance-Sparrow BRDF equation, F term is the Fresnel reflection term, D term is the micro-facet distribution term, G term comes from the shadowing and masking from the micro-facets](./assets/torrance_sparrow_brdf_eq.png)
</Figure>



<Figure caption="Torrance-Sparrow BRDF sphere">
  ![Torrance-Sparrow BRDF sphere](./assets/brdf_torrancesparrow.png)
</Figure>



<Figure caption="Killeroo model with Torrance-Sparrow BRDF">
  ![Killeroo model with Torrance-Sparrow BRDF](./assets/killeroo_torrancesparrow.png)
</Figure>
...
<Figure caption="Cornell box with a mesh light">
  ![Cornell box with a mesh light](./assets/cornellbox_jaroslav_diffuse_area.png)
</Figure>



<Figure caption="Cornell box with a mesh light, spheres with glossy surfaces">
  ![Cornell box with a mesh light, spheres with glossy surfaces](./assets/cornellbox_jaroslav_glossy_area.png)
</Figure>



<Figure caption="Cornell box with a point light for comparision, materials are not glossy">
  ![Cornell box with a point light for comparision, materials are not glossy](./assets/cornellbox_jaroslav_diffuse.png)
</Figure>



<Figure caption="Cornell box with a small mesh light, spheres with glossy surfaces">
  ![Cornell box with a small mesh light, spheres with glossy surfaces](./assets/cornellbox_jaroslav_glossy_area_small.png)
</Figure>
...
<Figure caption="Cornell box with a sphere light, spheres with glossy surfaces">
  ![Cornell box with a sphere light, spheres with glossy surfaces](./assets/cornellbox_jaroslav_glossy_area_sphere.png)
</Figure>
...
<Figure caption="Cornell box with an ellipsoid light, spheres with glossy surfaces">
  ![Cornell box with an ellipsoid light, spheres with glossy surfaces](./assets/cornellbox_jaroslav_glossy_area_ellipsoid.png)
</Figure>
...
<Figure caption="Cornell box with a prism light, 100 samples">
  ![Cornell box with a prism light, 100 samples](./assets/diffuse_prism.png)
</Figure>



<Figure caption="Cornell box with a sphere light, 400 samples">
  ![Cornell box with a sphere light, 400 samples](./assets/diffuse_sphere_light.png)
</Figure>
...
<Figure caption="Cosine weighted sampling">
  ![Cosine weighted sampling](./assets/cosine_sampling.png)
</Figure>
...
<Figure caption="Cornell box with a prism light, 100 samples, importance sampling">
  ![Cornell box with a prism light, 100 samples, importance sampling](./assets/diffuse_importance_prism.png)
</Figure>



<Figure caption="Cornell box with a sphere light, 400 samples, importance sampling">
  ![Cornell box with a sphere light, 400 samples, importance sampling](./assets/diffuse_importance_sphere_light.png)
</Figure>
...
<Figure caption="Cornell box with a prism light, 100 samples, Next Event Estimation">
  ![Cornell box with a prism light, 100 samples, Next Event Estimation](./assets/diffuse_nee_prism.png)
</Figure>



<Figure caption="Cornell box with a sphere light, 400 samples, Next Event Estimation">
  ![Cornell box with a sphere light, 400 samples, Next Event Estimation](./assets/diffuse_nee_sphere_light.png)
</Figure>
...
<Figure caption="Cornell box with a sphere light, 100 samples, Importance Sampling, Next Event Estimation, Wrong Calculation">
  ![Cornell box with a sphere light, 100 samples, Importance Sampling, Next Event Estimation, Wrong Calculation](./assets/diffuse_importance_nee_over_correction.png)
</Figure>



<Figure caption="Cornell box with a sphere light, 100 samples, Importance Sampling, Next Event Estimation, Correct Calculation">
  ![Cornell box with a sphere light, 100 samples, Importance Sampling, Next Event Estimation, Correct Calculation](./assets/diffuse_importance_nee_non_over_corrected.png)
</Figure>



<Figure caption="Cornell box with a sphere light, 400 samples, Importance Sampling, Next Event Estimation, Correct Calculation, Glass Material">
  ![Cornell box with a sphere light, 400 samples, Importance Sampling, Next Event Estimation, Correct Calculation, Glass Material](./assets/glass_importance_nee_weighted_revised.png)
</Figure>
...
<Figure caption="Cornell box with a sphere light, 25 samples, Importance Sampling, Next Event Estimation, Russian Roulette, Rays Splitting into 2">
  ![Cornell box with a sphere light, 25 samples, Importance Sampling, Next Event Estimation, Russian Roulette, Rays Splitting into 2](./assets/diffuse_importance_nee_russian_splitting_2.png)
</Figure>



<Figure caption="Cornell box with a sphere light, 25 samples, Importance Sampling, Next Event Estimation, Russian Roulette, Rays Splitting into 3">
  ![Cornell box with a sphere light, 25 samples, Importance Sampling, Next Event Estimation, Russian Roulette, Rays Splitting into 3](./assets/diffuse_importance_nee_russian_splitting_3.png)
</Figure>



<Figure caption="Cornell box with a sphere light, 25 samples, Importance Sampling, Next Event Estimation, Russian Roulette, Rays Splitting into 4">
  ![Cornell box with a sphere light, 25 samples, Importance Sampling, Next Event Estimation, Russian Roulette, Rays Splitting into 4](./assets/diffuse_importance_nee_russian_splitting_4.png)
</Figure>
...
<Figure caption="We converged a little bit early">
  ![We converged a little bit early](./assets/bloopers/1.png)
</Figure>



<Figure caption="Like an alien abduction">
  ![Like an alien abduction](./assets/bloopers/2.png)
</Figure>



<Figure caption="Some neon vibes">
  ![Some neon vibes](./assets/bloopers/3.png)
</Figure>


<Figure caption="Neon vibes, but brighter">
  ![Neon vibes, but brighter](./assets/bloopers/5.png)
</Figure>



<Figure caption="Like the movie Tron">
  ![Like the movie Tron](./assets/bloopers/7.png)
</Figure>



<Figure caption="Could it be an cartoon shader?">
  ![Could it be an cartoon shader?](./assets/bloopers/8.png)
</Figure>



<Figure caption="Lost in the noise">
  ![Lost in the noise](./assets/bloopers/9.png)
</Figure>



<Figure caption="Fogs without additional cost">
  ![Fogs without additional cost](./assets/bloopers/10.png)
</Figure>



<Figure caption="Light mesh in the glass seems suspicious">
  ![Light mesh in the glass seems suspicious](./assets/bloopers/12.png)
</Figure>
