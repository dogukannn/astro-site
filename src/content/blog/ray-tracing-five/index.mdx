...
description: 'Here we will implement additional lighting types, and will implement tonemapping.'
date: 2024-12-28
...
<Figure caption="Dragon model with a spot light">
  ![Dragon model with a spot light](./assets/dragon_spot_light_msaa.png)
</Figure>



<Figure caption="Different dragon model with tree spot lights">
  ![Different dragon model with tree spot lights](./assets/dragon_new_with_spot.png)
</Figure>



<Figure caption="Same scene with a parser error, making it a bit scarier">
  ![Same scene with a parser error, making it a bit scarier](./assets/dragon_new_with_spot_red.png)
</Figure>
...
<Figure caption="Cube with a directional light present">
  ![Cube with a directional light present](./assets/cube_directional.png)
</Figure>
...
<Figure caption="Latidude-Longitude Map">
  ![Latidude-Longitude Map](./assets/campus_probe_latlong.png)
</Figure>
...
<Figure caption="Spherical Map">
  ![Spherical Map](./assets/campus_probe.png)
</Figure>
...
<Figure caption="Lights sampled with wrong directions, faces near the object outlines appear darker">
  ![Lights sampled with wrong directions, faces near the object outlines appear darker](./assets/head_env_light_sampling_error.png)
</Figure>



<Figure caption="Lights sampled with correct directions">
  ![Lights sampled with correct directions](./assets/head_env_light.png)
</Figure>
...
<Figure caption="Sigmoidal compresiion">
  ![Sigmoidal compresiion](./assets/sigmoidal_tmo.png)
</Figure>



<Figure caption="Compression with burnout values">
  ![Compression with burnout values](./assets/burnout_tmo.png)
</Figure>
...
<Figure caption="Compression with burnout values">
  ![Compression with burnout values](./assets/rgb_conv.png)
</Figure>
...
<Figure caption="Cube and a point light without tonemapping">
  ![Cube and a point light without tonemapping](./assets/cube_point.png)
</Figure>



<Figure caption="Cube and a point light with tonemapping">
  ![Cube and a point light with tonemapping](./assets/cube_point_hdr.png)
</Figure>
...
<Figure caption="Car model with wrong texture coordinates and missing shadows">
  ![Car model with wrong texture coordinates and missing shadows](./assets/audi-tt-pisa_wrong_textures_1600.png)
</Figure>



<Figure caption="Car model with less samples but correct shadows and textures, we can see the soft shadows created by the multisampling with different directions">
  ![Car model with less samples but correct shadows and textures, we can see the soft shadows created by the multisampling with different directions](./assets/audi-tt-pisa.png)
</Figure>
...
<Figure caption="Car model with a different environmental map, the difference is huge">
  ![Car model with a different environmental map, the difference is huge](./assets/audi-tt-glacier.png)
</Figure>



<Figure caption="Glass sphere with an environmental map">
  ![Glass sphere with an environmental map](./assets/glass_sphere_env.png)
</Figure>



<Figure caption="Mirror sphere with an environmental map">
  ![Mirror sphere with an environmental map](./assets/mirror_sphere_env.png)
</Figure>



<Figure caption="Mirror sphere with an environmental map without tonemapping">
  ![Mirror sphere with an environmental map without tonemapping](./assets/mirror_sphere_env_no_tonemapping.png)
</Figure>



<Figure caption="Sphere with a point light and an environmental map">
  ![Sphere with a point light and an environmental map](./assets/sphere_point_hdr_texture.png)
</Figure>



<Figure caption="Sphere with an environmental map">
  ![Sphere with an environmental map](./assets/sphere_env_light.png)
</Figure>
