...
description: 'Here we will dive into subdivision algorithms.'
date: 2022-04-29
...
<Figure caption="The d are the original vertices coordinates. R means the average of the neighbour edge points, and S means the average of the neighbour face points. The result will be a formulated weighted average of these points.">
  ![The d are the original vertices coordinates. R means the average of the neighbour edge points, and S means the average of the neighbour face points. The result will be a formulated weighted average of these points.](./assets/formula.png)
</Figure>
...
<Figure caption="">
  ![Figure](./assets/c-cube-1.png)
</Figure>



<Figure caption="">
  ![Figure](./assets/c-cube-2.png)
</Figure>
...
<Figure caption="">
  ![Figure](./assets/heart-with-hole.png)
</Figure>
...
<Figure caption="">
  ![Figure](./assets/heart-without-hole.png)
</Figure>



<Figure caption="">
  ![Figure](./assets/heart-without-hole-from-bottom.png)
</Figure>
...
<Figure caption="">
  ![Figure](./assets/heart-catmull-one-image.png)
</Figure>



<Figure caption="Because of the complexity of the shape, the subdivision is not as visible as the other ones.">
  ![Because of the complexity of the shape, the subdivision is not as visible as the other ones.](./assets/space-station-one-image.png)
</Figure>
...
<Figure caption="">
  ![Figure](./assets/3-subdiv-formula.png)
</Figure>
...
<Figure caption="The decrease of total surface area exists in this algorithm too.">
  ![The decrease of total surface area exists in this algorithm too.](./assets/bunny-three.png)
</Figure>



<Figure caption="">
  ![Figure](./assets/cup-three.png)
</Figure>



<Figure caption="We can see from the iterations that holes are handled.">
  ![We can see from the iterations that holes are handled.](./assets/dragon-three.png)
</Figure>
