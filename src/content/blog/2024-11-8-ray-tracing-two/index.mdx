...
<Figure caption="Dragon model with BVH structure rendered in 789ms">
  ![Dragon model with BVH structure rendered in 789ms](./assets/chinese_dragon_noisy_old_threading_789.png)
</Figure>
...
<Figure caption="Dragon model without artifacts in 730ms">
  ![Dragon model without artifacts in 730ms](./assets/chinese_dragon_no_noise.png)
</Figure>
