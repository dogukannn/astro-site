...
description: 'Here we will implement multisampling to our CPU ray tracer.'
date: 2024-11-27
...
<Figure caption="Difference can be seen in the edges ot the objects">
  ![Difference can be seen in the edges ot the objects](./assets/edgealias.png)
</Figure>
...
<Figure caption="Dragon models with Depth Of Field effect">
  ![Dragon models with Depth Of Field effect](./assets/dof1.png)
</Figure>



<Figure caption="Spheres with Depth Of Field effect">
  ![Spheres with Depth Of Field effect](./assets/dof2.png)
</Figure>
...
<Figure caption="Cornellbox with motion blur effect">
  ![Cornellbox with motion blur effect](./assets/motionblur1.png)
</Figure>



<Figure caption="Dragons with motion blur effect">
  ![Dragons with motion blur effect](./assets/motionblur2.png)
</Figure>
...
<Figure caption="Cornellbox with glossy surfaces">
  ![Cornellbox with glossy surfaces](./assets/glossy1.png)
</Figure>



<Figure caption="Rough metal surface and blurry glasses">
  ![Rough metal surface and blurry glasses](./assets/glossy2.png)
</Figure>
...
<Figure caption="Cornellbox with area lights">
  ![Cornellbox with area lights](./assets/arealight.png)
</Figure>
...
<VideoPlayer src="/videos/tap_water.mp4" />
