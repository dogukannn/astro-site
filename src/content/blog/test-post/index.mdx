...
description: 'Here we will optimize our CPU ray tracer with acceleration structures.'
date: 2024-11-08
tags: ['Ray Tracing']
...
<Figure caption="Dragon model with BVH structure rendered in 789ms first">
![Dragon model with BVH structure rendered in 789mshola](./assets/chinese_dragon_noisy_old_threading_789.png)
</Figure>

<Figure caption="Dragon model with BVH structure rendered in 789ms second">
![Dragon model with BVH structure rendered in 789mshola](./assets/chinese_dragon_noisy_old_threading_789.png)
</Figure>
...
<Figure caption="Dragon model without artifacts in 730ms">
![Dragon model without artifacts in 730mshola](./assets/chinese_dragon_no_noise.png)
</Figure>
...
<Figure caption="9 Dragon instances rendered in 1188ms">
![9 Dragon instances rendered in 1188ms](./assets/marching_dragons.png)
</Figure>
...
<Figure caption="Faulty normals of the grass">
![Faulty normals of the grass](./assets/grass_desert_wrong.png)
</Figure>

<Figure caption="Correct version of the normals rendered in 6679ms">
![Correct version of the normals rendered in 6679ms](./assets/grass_desert_correct.png)
</Figure>
...
<Figure caption="Windmill scene rendered with a better split in 484ms, 2x faster than the basic split method">
![Windmill scene rendered with a better split in 484ms, 2x faster than the basic split method](./assets/windmill_smooth.png)
</Figure>
...
<Figure caption="Windmill scene rendered with a TLAS BVH in 419ms">
![Windmill scene rendered with a TLAS BVH in 419ms](./assets/windmill_smooth.png)
</Figure>
...
<VideoPlayer src="/videos/davids_camera_no_tlas_basic_split_tiled_250ms.mp4" />
<VideoPlayer src="/videos/davids_no_tlas_basic_split_tiled_250ms.mp4" />
<VideoPlayer src="/videos/windmill_tlas_exp_split_tiled_450ms.mp4" />

<Figure caption="Chinese Dragon">
  ![Chinese Dragon](./assets/tests/chinese_dragon.png)
</Figure>

<Figure caption="Metal Dragon">
  ![Metal Dragon](./assets/tests/dragon_metal.png)
</Figure>

<Figure caption="Ellipsoids">
  ![Ellipsoids](./assets/tests/ellipsoids.png)
</Figure>

<Figure caption="Glaring Davids">
  ![Glaring Davids](./assets/tests/glaring_davids.png)
</Figure>

<Figure caption="Grass Desert">
  ![Grass Desert](./assets/tests/grass_desert.png)
</Figure>

<Figure caption="Lobster">
  ![Lobster](./assets/tests/lobster.png)
</Figure>

<Figure caption="Marching Dragons">
  ![Marching Dragons](./assets/tests/marching_dragons.png)
</Figure>
  
<Figure caption="Metal Glass Plates">
  ![Metal Glass Plates](./assets/tests/metal_glass_plates.png)
</Figure>

<Figure caption="Science Tree">
  ![Science Tree](./assets/tests/scienceTree.png)
</Figure>

<Figure caption="Simple Transform">
  ![Simple Transform](./assets/tests/simple_transform.png)
</Figure>

<Figure caption="Spheres">
  ![Spheres](./assets/tests/spheres.png)
</Figure>
...
<Figure caption="Ton Roosendaal">
  ![Ton Roosendaal](./assets/tests/ton_Roosendaal_smooth.png)
</Figure>

<Figure caption="Two Berserkers">
  ![Two Berserkers](./assets/tests/two_berserkers.png)
</Figure>

<Figure caption="Windmill">
  ![Windmill](./assets/tests/windmill_000.png)
</Figure>
