...
description: 'Here we will create a scene with volumetric fog using ray marching.'
date: 2023-08-24
...
<Figure caption="">
  ![Figure](./assets/rays_bouncing.jpg)
</Figure>
...
<Figure caption="">
  ![Figure](./assets/rays_in_cloud.jpg)
</Figure>
...
<Figure caption="">
  ![Figure](./assets/cloud_basic.gif)
</Figure>



<Figure caption="">
  ![Figure](./assets/cloud_in_sphere.gif)
</Figure>
...
<Figure caption="Back face culled depth buffer for entry points.">
  ![Back face culled depth buffer for entry points.](./assets/back_culled.png)
</Figure>



<Figure caption="Front face culled depth buffer for entry points.">
  ![Front face culled depth buffer for entry points.](./assets/front_culled.png)
</Figure>
