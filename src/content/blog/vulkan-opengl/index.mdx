...
description: 'Here we will compare OpenGL and Vulkan with a scene with dynamic cubemaps.'
date: 2022-07-01
...
<Figure caption="">
  ![Figure](./assets/reflect.jpg)
</Figure>



<Figure caption="A scene with a reflective teapot and orbiting objects. We can see that the reflections are crystal clear.">
  ![A scene with a reflective teapot and orbiting objects. We can see that the reflections are crystal clear.](./assets/reflection1.gif)
</Figure>
...
<VideoPlayer src="/videos/vulkan_teapot.mp4" />
...
<VideoPlayer src="/videos/vulkan_cube.mp4" />
Above is the Vulkan Implementation.

<VideoPlayer src="/videos/opengl_cube.mp4" />
Above is the OpenGL Implementation.


<Figure caption="The results show that, in the scene with the cube models, OpenGL is faster.">
  ![The results show that, in the scene with the cube models, OpenGL is faster.](./assets/cube_test.png)
</Figure>
...
<VideoPlayer src="/videos/opengl_teapot.mp4" />
Above is the OpenGL Implementation.


<Figure caption="The results show that, in the scene with the teapot models, OpenGL is still faster. However, the difference is slowly decreasing">
  ![The results show that, in the scene with the teapot models, OpenGL is still faster. However, the difference is slowly decreasing](./assets/teapot_test.png)
</Figure>
...
<VideoPlayer src="/videos/vulkan_hover.mp4" />
Above is the Vulkan Implementation.

<VideoPlayer src="/videos/opengl_hover.mp4" />
Above is the OpenGL Implementation.


<Figure caption="With the increased number of polygons we can see that Vulkan is performing better than OpenGL.">
  ![With the increased number of polygons we can see that Vulkan is performing better than OpenGL.](./assets/hover_test.png)
</Figure>
...
<Figure caption="All the data we collected from these 3 different scenes.">
  ![All the data we collected from these 3 different scenes.](./assets/table.png)
</Figure>
