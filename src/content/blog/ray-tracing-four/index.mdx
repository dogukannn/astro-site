...
description: 'Here we will implement texture sampling methods, normal mapping and bump mapping.'
date: 2024-12-12
...
<Figure caption="Brick wall texture mapped onto a cube, values replacing diffuse reflectance">
  ![Brick wall texture mapped onto a cube, values replacing diffuse reflectance](./assets/cube_wall.png)
</Figure>



<Figure caption="Wood texture mapped onto a cube, values replacing diffuse reflectance">
  ![Wood texture mapped onto a cube, values replacing diffuse reflectance](./assets/wood_box.png)
</Figure>
...
<Figure caption="Earth texture mapped onto a sphere, left is a bumped version which I will cover later on">
  ![Earth texture mapped onto a sphere, left is a bumped version which I will cover later on](./assets/sphere_nobump_bump.png)
</Figure>
...
<Figure caption="Nearest neighbor sampling vs bilinear sampling">
  ![Nearest neighbor sampling vs bilinear sampling](./assets/sphere_nearest_bilinear.png)
</Figure>




<Figure caption="Nearest neighbor sampling">
  ![Nearest neighbor sampling](./assets/plane_nearest.png)
</Figure>



<Figure caption="Bilinear sampling">
  ![Bilinear sampling](./assets/plane_trilinear.png)
</Figure>
...
<Figure caption="">
  ![Figure](./assets/cushion.png)
</Figure>



<Figure caption="Normal map applied to a cube">
  ![Normal map applied to a cube](./assets/cube_cushion.png)
</Figure>



<Figure caption="Normal map applied to a cube">
  ![Normal map applied to a cube](./assets/cube_waves.png)
</Figure>



<Figure caption="Normal map applied to a sphere">
  ![Normal map applied to a sphere](./assets/sphere_normal.png)
</Figure>



<Figure caption="Normal map applied to a cube">
  ![Normal map applied to a cube](./assets/cube_wall_normal.png)
</Figure>



<Figure caption="Normal map applied to a cube">
  ![Normal map applied to a cube](./assets/brickwall_with_normalmap.png)
</Figure>
...
<Figure caption="Earth texture mapped onto a sphere with bump values">
  ![Earth texture mapped onto a sphere with bump values](./assets/sphere_nobump_bump.png)
</Figure>



<Figure caption="Earth texture mapped onto a sphere with bump values">
  ![Earth texture mapped onto a sphere with bump values](./assets/sphere_nobump_justbump.png)
</Figure>



<Figure caption="Wood texture mapped onto a cube with bump values">
  ![Wood texture mapped onto a cube with bump values](./assets/wood_box_all.png)
</Figure>



<Figure caption="Wall texture mapped onto a cube with bump values">
  ![Wall texture mapped onto a cube with bump values](./assets/killeroo_bump_walls.png)
</Figure>



<Figure caption="Bump mapping applied to a spaceship with motion blur">
  ![Bump mapping applied to a spaceship with motion blur](./assets/galactica_dynamic.png)
</Figure>



<Figure caption="Bump mapping applied to a transformed model">
  ![Bump mapping applied to a transformed model](./assets/bump_mapping_transformed.png)
</Figure>



<Figure caption="Bump mapping applied to a transformed model">
  ![Bump mapping applied to a transformed model](./assets/mytap_final.png)
</Figure>
...
<Figure caption="Perlin noise bump mapping applied to a sphere">
  ![Perlin noise bump mapping applied to a sphere](./assets/sphere_perlin_bump.png)
</Figure>



<Figure caption="Perlin noise bump mapping applied to a cube">
  ![Perlin noise bump mapping applied to a cube](./assets/cube_perlin_bump.png)
</Figure>
...
<Figure caption="Perlin noise applied to a sphere">
  ![Perlin noise applied to a sphere](./assets/sphere_perlin.png)
</Figure>



<Figure caption="Perlin noise applied to a sphere with scale">
  ![Perlin noise applied to a sphere with scale](./assets/sphere_perlin_scale.png)
</Figure>




<Figure caption="Different textures applied to a bunch of ellipsoids">
  ![Different textures applied to a bunch of ellipsoids](./assets/ellipsoids_texture.png)
</Figure>



<Figure caption="Perlin noise applied to a dragon model">
  ![Perlin noise applied to a dragon model](./assets/dragon_new.png)
</Figure>
