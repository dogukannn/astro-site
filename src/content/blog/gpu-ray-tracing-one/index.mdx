...
<Figure caption="Figure taken from Will Usher's blog, showing a shader binding table with two instances, the second instance having two different geometries with different values for shader indices">
  ![Figure taken from Will Usher's blog, showing a shader binding table with two instances, the second instance having two different geometries with different values for shader indices](./assets/sbt_offset.png)
</Figure>
...
<Figure caption="Final result of the ray tracer">
...
<Figure caption="">
  ![Figure](./assets/Screenshot%202025-01-19%20171306.png)
</Figure>



<Figure caption="">
  ![Figure](./assets/Screenshot%202025-01-20%20022100.png)
</Figure>



<Figure caption="">
  ![Figure](./assets/Screenshot%202025-01-20%20022216.png)
</Figure>



<Figure caption="Buggy result from the initial try">
