...
<Figure caption="Figure taken from Will Usher's blog, showing a shader binding table with two instances, the second instance having two different geometries with different values for shader indices">
![shader binding table](./assets/sbt_offset.png)
</Figure>
...
<Figure caption="Final result of the ray tracer" className="figcenter fighighlight">
  <img src="/assets/RayTracer_bcRQDA2kbY.jpg" alt="Final result of the ray tracer" />
</Figure>

<Figure className="figcenter fighighlight">
  <img src="/assets/Screenshot 2025-01-19 171306.png" alt="Screenshot 2025-01-19 171306" />
</Figure>

<Figure className="figcenter fighighlight">
  <img src="/assets/Screenshot 2025-01-20 022100.png" alt="Screenshot 2025-01-20 022100" />
</Figure>

<Figure className="figcenter fighighlight">
  <img src="/assets/Screenshot 2025-01-20 022216.png" alt="Screenshot 2025-01-20 022216" />
</Figure>

<Figure caption="Buggy result from the initial try" className="figcenter fighighlight">
  <img src="/assets/Screenshot 2025-01-19 163921.png" alt="Buggy result from the initial try" />
</Figure>

## Videos

<VideoPlayer src="/assets/RayTracer_diffuse.mp4" />

<VideoPlayer src="/assets/RayTracer_free_movement.mp4" />

<VideoPlayer src="/assets/RayTracer_heart_light.mp4" />

<VideoPlayer src="/assets/RayTracer_static_without_nee.mp4" />

<VideoPlayer src="/assets/RayTracer_tourus-glass.mp4" />

<VideoPlayer src="/assets/RayTracer_tourus.mp4" />
