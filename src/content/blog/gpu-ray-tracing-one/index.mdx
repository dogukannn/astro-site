...
<Figure caption="Final result of the ray tracer" className="figcenter fighighlight">
  ![Final result of the ray tracer](./assets/RayTracer_bcRQDA2kbY.jpg)
</Figure>

<Figure className="figcenter fighighlight">
  ![Screenshot 2025-01-19 171306](./assets/Screenshot%202025-01-19%20171306.png)
</Figure>

<Figure className="figcenter fighighlight">
  ![Screenshot 2025-01-20 022100](./assets/Screenshot%202025-01-20%20022100.png)
</Figure>

<Figure className="figcenter fighighlight">
  ![Screenshot 2025-01-20 022216](./assets/Screenshot%202025-01-20%20022216.png)
</Figure>

<Figure caption="Buggy result from the initial try" className="figcenter fighighlight">
  ![Buggy result from the initial try](./assets/Screenshot%202025-01-19%20163921.png)
</Figure>

## Videos

<VideoPlayer src="/videos/RayTracer_diffuse.mp4" />

<VideoPlayer src="/videos/RayTracer_free_movement.mp4" />

<VideoPlayer src="/videos/RayTracer_heart_light.mp4" />

<VideoPlayer src="/videos/RayTracer_static_without_nee.mp4" />

<VideoPlayer src="/videos/RayTracer_tourus-glass.mp4" />

<VideoPlayer src="/videos/RayTracer_tourus.mp4" />
