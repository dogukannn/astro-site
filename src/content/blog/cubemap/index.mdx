...
description: 'Here we will glance into cubemaps and their use cases.'
date: 2022-05-18
...
<Figure caption="">
  ![Figure](./assets/hdr.png)
</Figure>



<Figure caption="">
  ![Figure](./assets/tocubemap.png)
</Figure>
...
<Figure caption="">
  ![Figure](./assets/cubemaprotate.gif)
</Figure>
...
<Figure caption="An example of a refractive cube.">
  ![An example of a refractive cube.](./assets/refraction.png)
</Figure>
...
<Figure caption="LiDAR sensor points on the simulation environment.">
  ![LiDAR sensor points on the simulation environment.](./assets/lgsvl.png)
</Figure>



<Figure caption="An example of a depth-cubemap.">
  ![An example of a depth-cubemap.](./assets/depth.png)
</Figure>
