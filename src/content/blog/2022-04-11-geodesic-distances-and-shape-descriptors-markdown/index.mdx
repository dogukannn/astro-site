...
<Figure caption="Red line is geodesic distance and the blue line is the euclidean distance.">
  ![Red line is geodesic distance and the blue line is the euclidean distance.](./assets/geodesic_example.png)
</Figure>
...
<Figure caption="Comparision between different paths.">
  ![Comparision between different paths.](./assets/real_shortest_path.png)
</Figure>
...
<Figure caption="Shortest path drawed on the mesh with red.">
  ![Shortest path drawed on the mesh with red.](./assets/q1.png)
</Figure>
...
<Figure caption="Difference in timings calculating N x N matrix of shortest distances between vertices.">
  ![Difference in timings calculating N x N matrix of shortest distances between vertices.](./assets/nxn_dijkstra.png)
</Figure>
...
<Figure caption="A shape descriptor called light field which uses 10 different angle silhouette images to compare the meshes.">
  ![A shape descriptor called light field which uses 10 different angle silhouette images to compare the meshes.](./assets/light_field.png)
</Figure>
...
<Figure caption="The iso-curves of a mesh whose colors are interpolated with respect to their distances to the source vertex.">
  ![The iso-curves of a mesh whose colors are interpolated with respect to their distances to the source vertex.](./assets/q2a.png)
</Figure>



<Figure caption="Geodesic iso-curve signature of our mesh from a vertex from the head. The y axis show the total length and x axis shows the distance of the iso-curve from the vertex.">
  ![Geodesic iso-curve signature of our mesh from a vertex from the head. The y axis show the total length and x axis shows the distance of the iso-curve from the vertex.](./assets/q2a_chart.png)
</Figure>
...
<Figure caption="The mesh is colored according to their distances to the path between vertices.">
  ![The mesh is colored according to their distances to the path between vertices.](./assets/q2b.png)
</Figure>



<Figure caption="The two end points of our path gives different results. These histograms are our bilateral maps.">
  ![The two end points of our path gives different results. These histograms are our bilateral maps.](./assets/q2b_chart81.png)
</Figure>
...
<Figure caption="The different colors stand for different bars of our histogram.">
  ![The different colors stand for different bars of our histogram.](./assets/q2b_areas.png)
</Figure>



<Figure caption="The mesh is colored according to their distances to the path between vertices.">
  ![The mesh is colored according to their distances to the path between vertices.](./assets/q2b_high_res.png)
</Figure>
