...
description: 'Here we will create surfaces with patches on OpenGL 4.6 with animations.'
date: 2022-04-12
...
<Figure caption="Interpolation of the Bezier curve.">
  ![Interpolation of the Bezier curve.](./assets/bezier.gif)
</Figure>



<Figure caption="Blending function of Bezier curves which shows the effect of the control points through the curve.">
  ![Blending function of Bezier curves which shows the effect of the control points through the curve.](./assets/blending-functions-bezier.png)
</Figure>
...
<Figure caption="">
  ![Figure](./assets/bezier_surface.png)
</Figure>
...
<Figure caption="">
  ![Figure](./assets/bezier_surface_control_points.png)
</Figure>
...
<Figure caption="Equations for the bezier curve with matrices.">
  ![Equations for the bezier curve with matrices.](./assets/bezier_equations.png)
</Figure>
...
<Figure caption="My first implementation with 10 sample points.">
  ![My first implementation with 10 sample points.](./assets/my_first_surface.png)
</Figure>
...
<Figure caption="A surface constructed from multiple patches.">
  ![A surface constructed from multiple patches.](./assets/edge.png)
</Figure>
...
<Figure caption="Capturing frames from our application.">
  ![Capturing frames from our application.](./assets/render_doc_0.png)
</Figure>


<Figure caption="Mesh viewer interface of the RenderDoc.">
  ![Mesh viewer interface of the RenderDoc.](./assets/render_doc_1.png)
</Figure>


<Figure caption="Shader pipeline viewer of the RenderDoc.">
  ![Shader pipeline viewer of the RenderDoc.](./assets/render_doc_2.png)
</Figure>
...
<Figure caption="The zoomed version of our problem.">
  ![The zoomed version of our problem.](./assets/edge_zoomed_in.png)
</Figure>
...
<Figure caption="The angles of the vertices showing our problem.">
  ![The angles of the vertices showing our problem.](./assets/angles.png)
</Figure>
...
<Figure caption="The edge artifacts disappeared.">
  ![The edge artifacts disappeared.](./assets/after_solve.png)
</Figure>
...
<Figure caption="Rotating our surface with mouse.">
  <img
    src={`${import.meta.env.BASE_URL}/static/rotation.gif`}
    alt="Rotating our surface with mouse."
    loading="lazy"
  />
</Figure>
